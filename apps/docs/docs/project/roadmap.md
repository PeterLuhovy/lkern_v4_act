---
id: roadmap
title: L-KERN v4 Development Roadmap
...
- ✅ Added lkms503-zookeeper (port 2181 - exception to 4-XXX pattern)
...
- ✅ Updated `docs/architecture/port-mapping.md` to v2.0.0
  ...
  - Added lkms504-kafka (port 4503)
  - Added gRPC port convention (5-XXX range)
...
- `POST /api/v1/contacts/:id/relations?type=tag|language|social_network|...` - Add relation
- `PUT /api/v1/contacts/:id/relations/:relation_id?type=...` - Update relation
- `DELETE /api/v1/contacts/:id/relations/:relation_id?type=...` - Remove relation
- `GET /api/v1/contacts/:id/relations?type=...` - Get all relations

**Universal Validation (1):**
- `GET /api/v1/contacts/validate?type=email|phone|website|...&value=...` - Validate field
...
- ⏸️ **Add translation keys for authentication**
  - `auth.login.*` - Login page (15 keys)
    - Example: forgotPassword with link interpolation for "Reset it here"
  - `auth.register.*` - Registration page (20 keys)
    - Example: termsAccept with terms and privacy link interpolation
...
#### **1.207.2 Docusaurus Documentation Site (2-3h)** ✅ COMPLETED (2025-12-17)
- ✅ **DONE:** Migrated all docs to Docusaurus format (19 documents)
- ✅ **DONE:** Fixed MDX compilation errors in 4 files (roadmap, design-standards, docs-standards, testing-best-practices)
- ✅ **DONE:** Sidebar categories configured with proper navigation
- ✅ **DONE:** All documentation pages created and working
...
### **1.208 Storybook Component Documentation** ✅ COMPLETED (2025-12-17)
**Dependencies:** 1.207.2 complete
**Estimated:** 8-12h
**Actual:** ~6h
**Completed:** 2025-12-17

**Interactive component documentation with Storybook 8.x**

#### **1.208.1 Storybook Setup (1-2h)** ✅ COMPLETED
- ✅ Storybook 8.4.7 configuration (Vite-based)
- ✅ `.storybook/main.ts` - React-Vite framework config
- ✅ `.storybook/preview.ts` - TranslationProvider + ThemeProvider decorators
- ✅ A11y addon for accessibility testing
- ✅ Autodocs for automatic documentation generation

#### **1.208.2 Component Stories (4-6h)** ✅ COMPLETED
- ✅ **Forms (7):** Input, Select, Checkbox, Radio, Textarea, FormField, FileUpload
- ✅ **Feedback (6):** Badge, Spinner, Toast, ToastContainer, InfoHint, EmptyState
- ✅ **Layout (5):** Card, PageHeader, Sidebar, DashboardCard, StatusBar
- ✅ **Modals (9):** Modal, ConfirmModal, EditItemModal, ManagementModal, SectionEditModal, EntityEditModal, CreateIssueModal, IssueTypeSelectModal, ExportProgressModal
- ✅ **Data (6):** DataGrid, Pagination, FilterPanel, FilteredDataGrid, ExportButton, ReportButton
- ✅ **Utility (6):** WizardProgress, WizardNavigation, DebugBar, AuthRoleSwitcher, ThemeCustomizer, KeyboardShortcutsButton
- ✅ **Button (1):** Existing story updated

#### **1.208.3 Docusaurus Integration (1h)** ✅ COMPLETED
- ✅ Navbar "Components" link to `/storybook/`
- ✅ Footer link to Storybook
- ✅ ui-components.md tip box with Storybook link
- ✅ Build script outputs to `apps/docs/static/storybook/`

**Success Criteria:**
- ✅ 40 component stories created
- ✅ All stories compile without errors
- ✅ Storybook build successful (production ready)
- ✅ Accessible via Docusaurus at `/storybook/`
- ✅ A11y testing available for all components
