...
**See full specification:** [Microservices Architecture](../architecture/microservices-architecture.md)
...
- **Microservices Architecture:** [Microservices Spec](../architecture/microservices-architecture.md)
- **Coding Standards:** [Coding Standards](../guides/coding-standards.md)
- **Testing Guide:** [Testing Overview](../testing/testing-overview.md)
