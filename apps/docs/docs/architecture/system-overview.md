...
**See full specification:** [Microservices Architecture](./microservices-architecture.md)
...
- **Roadmap:** See project roadmap documentation
- **Microservices Architecture:** [Microservices Architecture](./microservices-architecture.md)
- **Port Mapping:** [Port Mapping Strategy](./port-mapping.md)
- **Coding Standards:** See programming documentation
- **Testing Guide:** See programming documentation
