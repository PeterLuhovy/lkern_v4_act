"""
================================================================
Contact Service (MDM) - Example gRPC Service
================================================================
File: services/lkms101-contacts/app/api/grpc/example_service.py
Version: v1.0.0
Created: 2025-11-08
Description:
...
class HealthService:
    ...
    async def Check(self, request: Any, context: Any) -> Any:
        ...
        return {
            ...
            "message": "Contact Service (MDM) is healthy",
        }
...
class ContactService:
    """
    Contact gRPC service for internal communication.

    Example methods for inter-service calls.
    """

    async def GetContact(self, request: Any, context: Any) -> Any:
        """
        Get Contact by ID (gRPC call).

        Args:
            request: GetContactRequest with id field
        ...
        logger.info("gRPC GetContact called")
        return {}
