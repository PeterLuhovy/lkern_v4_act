...
const AnalyticsPanel: React.FC<{ isCollapsed: boolean }> = ({ isCollapsed }) => {
  ...
  const debugItems: Array<{ key: keyof AnalyticsSettings; icon: string; labelKey: string; hintKey: string }> = [
    ...
    { key: 'logServiceWorkflow', icon: '<span role="img" aria-label="workflow">🎫</span>', labelKey: 'components.sidebar.analytics.logServiceWorkflow', hintKey: 'components.sidebar.analytics.logServiceWorkflowHint' },
